...
# There is another fucntion called discard() which is used to remove an element from a sets but it does not give error if the element is not present in the sets
...
print(all_names) # this will print {, 'kunal', 'sahil', 'rohit', 'yash'} because these are all the elements from both setss
